...
Tips.prototype.initFirebase = function() {
...
// Tips.prototype.loadMessages = function() {
//   this.messagesRef = this.database.ref('tips');
...
Tips.prototype.saveImageMessage = function(event) {
  ...
  if (!file.type.match('image.*')) {
    ...
    this.messagesRef.push({
      ...
      var filePath = 'admin' + '/' + 'tips' + '/' + data.key + '/' + file.name;
...
// Tips.prototype.saveMessagingDeviceToken = function() {
...
// Tips.prototype.requestNotificationsPermissions = function() {
...
// Tips.resetMaterialTextfield = function(element) {
//   element.value = '';
//   element.parentNode.MaterialTextfield.boundUpdateClassesHandler();
// };
//
// // Template for messages.
// Tips.MESSAGE_TEMPLATE =
...
// Tips.prototype.displayMessage = function(key, title, information, imageUrl) {
...
//
//
// Tips.prototype.toggleButton = function() {
...
Tips.prototype.checkSetup = function() {
